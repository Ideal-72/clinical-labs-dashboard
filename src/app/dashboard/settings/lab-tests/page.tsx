    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Manage laboratory test parameters and reference ranges</p>
        </div>
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">Normal Value</label>
                  <input
                    type="text"
                    ...
                    className="w-full border border-input rounded-lg px-3 py-2 text-foreground placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                  />
                  <p className="text-xs text-muted-foreground mt-1">{formData.normalValue.length}/30 characters</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-input rounded-lg px-3 py-2 text-foreground placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                  />
                  <p className="text-xs text-muted-foreground mt-1">{formData.unit.length}/20 characters</p>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="w-full border border-input rounded-lg px-3 py-2 text-foreground placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-sm"
                    />
                    <p className="text-xs text-muted-foreground mt-1">{formData.group.length}/30 characters</p>
                  </div>
                </div>
